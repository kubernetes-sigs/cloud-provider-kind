...
func (c *cloud) GetLoadBalancer(ctx context.Context, clusterName string, service *v1.Service) (status *v1.LoadBalancerStatus, exists bool, err error) {
	...
	l.V(2).Info("Get LoadBalancer cluster", "cluster", clusterName, "service", klog.KObj(service))
...
func (c *cloud) GetLoadBalancerName(ctx context.Context, clusterName string, service *v1.Service) string {
	l := klog.FromContext(ctx)
	l.V(2).Info("Get LoadBalancerName", "cluster", clusterName, "service", klog.KObj(service))
...
func (c *cloud) EnsureLoadBalancer(ctx context.Context, clusterName string, service *v1.Service, nodes []*v1.Node) (*v1.LoadBalancerStatus, error) {
	l := klog.FromContext(ctx)
	l.V(2).Info("Ensure LoadBalancer", "cluster", clusterName, "service", klog.KObj(service))
...
func (c *cloud) UpdateLoadBalancer(ctx context.Context, clusterName string, service *v1.Service, nodes []*v1.Node) error {
	l := klog.FromContext(ctx)
	l.V(2).Info("Update LoadBalancer", "cluster", clusterName, "service", klog.KObj(service))
...
func (c *cloud) EnsureLoadBalancerDeleted(ctx context.Context, clusterName string, service *v1.Service) error {
	l := klog.FromContext(ctx)
	l.V(2).Info("Get LoadBalancer deleted", "cluster", clusterName, "service", klog.KObj(service))
